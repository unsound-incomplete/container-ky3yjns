...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ky3yjns.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ky3yjns.containers.anotherwebservice.com/
...
```
git clone git@github.com:unsound-incomplete/container-ky3yjns.git
cd container-ky3yjns
```
...
```
docker attach container-ky3yjns
```
